...
QUnit.test('Testing calculate average temperature function with several sets of inputs', function (assert) {
    assert.equal(average(1,2), 1.5, 'Tested with two relatively small positive numbers');
    assert.equal(average(1,-2), -0.5, 'Tested with two relatively small positive and negative numbers');
    assert.equal(average(-1,-2), -1.5, 'Tested with two relatively small negative numbers');
    assert.equal(average(0,0), 0, 'Tested with two zero numbers');
